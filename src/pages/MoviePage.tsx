...
import { numberToMoney } from "../helpers/numberToMoveyConverter";
  ...
  return (
    isSuccess && (
      <div className="relative">
        ...
        >
          <div
            className={`absolute z-10 top-0 left-0 w-full h-full bg-gradient-to-b from-background/0 via-background/20 to-background
        ...
        <div className="wrapper z-20 relative py-5 pt-48 font-main">
          <div className="grid grid-cols-4 gap-2.5 ">
            ...
            />
            <div className="col-span-full bg-itemBackground dark:bg-itemBackgroundDark p-4 rounded-xl shadow-lg sm:col-span-3">
              ...
              <div className="flex gap-4 mt-6 flex-wrap">
                ...
                <div className="flex gap-x-1 items-center">
                  ...
                  <p>{timeConverter(data.runtime)}</p>
                </div>
                <div className="flex gap-x-1 items-center">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mt-6">
                ...
                {data.revenue > 0 && (
                  <div>
                    ...
                    <p>${numberToMoney(data.revenue)}</p>
                  </div>
                )}
              </div>
